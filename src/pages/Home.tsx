...
const Home = () => {
	return (
		<article className="w-full min-h-screen text-center flex flex-col items-center justify-center px-8 bg-cover bg-no-repeat">
			<h1 className="text-gray-800 text-2xl font-bold">Welcome to the most trusted event list app</h1>
			<p className="max-w-96 text-gray-600 text-lg font-semibold mt-4">
